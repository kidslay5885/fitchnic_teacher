...
// (신규 폼이라 DB에 데이터가 없으면 전체가 등록된다.)
function importMissing() {
  const CHANNEL = "머니업지원사업"; // 이 스크립트의 채널명 (source_platform과 동일)
